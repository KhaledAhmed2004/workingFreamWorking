...
Depends On: [Goal Artifact ID], [Principles Artifact ID], [Journey Artifact ID], [Requirements Artifact ID]
...
- **Traces To**: [MUST trace to 100_VisionStandard North Star ID]
...
- **Guarded By**: [MUST have at least one Guardrail MET-ID]
